...
/// Privacy Policy — Chues: cores e blocos
class TermoChuesPage extends StatelessWidget {
  const TermoChuesPage({super.key});

  @override
  Widget build(BuildContext context) {
    return const PoliticaPage(
      title: 'Chues: cores e blocos',
      subtitle:
      ...
      intro: [
        ...
        'Download and use our mobile application (Chues: cores e blocos), or '
            'any other application of ours that links to this Privacy Notice.',
        'Use Chues: cores e blocos — a color guessing game where players '
            'compete to guess colors based on HSL gradients in a turn-based '
            'format. The game is family friendly and suitable for all ages.',
        ...
        'Questions or concerns? Reading this Privacy Notice will help you '
            ...
            'please contact us at rondobyte@gmail.com.',
      ],
      summaryBullets: [
        ...
        PoliticaSection(
          ...
          paragraphs: [
            ...
            'If you have questions or comments about your privacy rights, you '
                'may email us at rondobyte@gmail.com.',
          ],
        ),
        PoliticaSection(
        ...
        PoliticaSection(
          ...
          paragraphs: [
            'If you have questions or comments about this notice, you may '
                'email us at rondobyte@gmail.com or contact us by post at:',
